<!-- p64 vendoring note -->
> **p64:** this is [esphome-libs/esp-hub75](https://github.com/esphome-libs/esp-hub75) 0.3.6
> (MIT, see `LICENSE`), copied from the component registry into `firmware/components/`
> so it can be patched. Local changes are marked `p64 patch` in the sources and listed
> in `P64-CHANGES.md` next to this file. Upstream README follows.
