// The settings document itself: defaults, clamping and the JSON form (spec section 16).
// No ESP-IDF includes: host-tested (tests/host/unit/system.cpp). The store (NVS, the
// shared view, change events) is settings.cpp.
