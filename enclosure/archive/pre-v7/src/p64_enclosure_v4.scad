...
part = "shell";            // "shell" | "print" | "assembly" | "section_usb" | "section_y" | "section_enc" | "product"
...
module ghosts() { ghost_panel(); ghost_chip(); if (usb_sockets) ghost_usb(); if (encoders) for (i = [0 : len(enc_pos) - 1]) ghost_encoder(enc_pos[i], enc_rot[i]); }
